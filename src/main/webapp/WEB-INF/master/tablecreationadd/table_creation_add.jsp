...
<%-- 								<h3 class="box-title">Table Creation Add <span class="badge badge-info ml-2"  th:text="${tablename}"></span></h3> --%>
								<h3 class="box-title">Table Creation Add <span class="badge badge-info ml-2" ><c:set var="tablename"  value="${tablename}" scope="request"/> <c:out value = "${tablename}"/></span></h3>
					    ...
					    <div class="box-body">
                            <div class="table-responsive custom-table-design">
                                <table class="table mb-0 adduservalue" id="creadtablefordom" style="width: 100%;">
                                         <input type="hidden" name="tabledefinitionid" id=tablenameid  value="${tablenameid}"/>
<%--                                            <input type="hidden" name="tabledefinitionid" id="tablenameid" th:if="${tablenameid}" th:value="${tablenameid}" > --%>
                                        <thead>
                                            <tr>
